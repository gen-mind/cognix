...
func (c *searchServiceClient) VectorSearch(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*SearchResponse, error) {
	out := new(SearchResponse)
	err := c.cc.Invoke(ctx, "/com.cognix.SearchService/VectorSearch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSearchServiceServer) VectorSearch(context.Context, *SearchRequest) (*SearchResponse, error) {
...
func _SearchService_VectorSearch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.cognix.SearchService/VectorSearch",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SearchServiceServer).VectorSearch(ctx, req.(*SearchRequest))
	}
...
var SearchService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "com.cognix.SearchService",
